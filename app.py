...
st.set_page_config(
    page_title="Heart Disease Prediction Dashboard", page_icon="🖥️"
)
...
app.add_page(
    "📈 Model Comparison & Selection", page_model_comparison_and_selection_body
)
app.add_page(
    "🩺 Heart Risk Predictor Tool", page_heart_risk_predictor_tool_body
)
