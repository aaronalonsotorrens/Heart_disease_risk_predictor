...
def page_project_overview_and_goals_body(data: pd.DataFrame):
    ...
    st.title("💡 Heart Disease Prediction Dashboard - Executive Summary & Overview")
    ...
    st.info(
        ...
        "reduce hospitalizations, and lower healthcare costs."
    )
    ...
    st.write(
        ...
        "- Early patterns in this dataset suggest risk stratification is possible using clinical features.\n"
    ...
    st.write(
        ...
        "- **Exercise-Induced Angina (exang)**: Positive cases show higher likelihood of heart disease.\n"
        "- **ST depression (oldpeak) & Maximum Heart Rate (thalach)**: Key predictors from numeric correlations.\n"
        "- **Thalassemia (thal) & Number of major vessels (ca)**: Strong categorical associations with disease outcome."
    )
    ...
    st.success(
        ...
        "2. Design monitoring protocols focusing on key clinical indicators.\n"
        "3. Leverage predictive models to recommend lifestyle changes or further testing.\n"
        "4. Use insights to allocate resources effectively and improve patient outcomes."
    )
